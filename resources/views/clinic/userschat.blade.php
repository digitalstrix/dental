        ...
        <main class="msger-chat">
            <div class="msg left-msg">
                ...
                <div class="msg-bubble">
                    ...
                    <div class="msg-text">
                        Hi {{ session('name') }} , welcome to Dentavibe! Go ahead and send messages to your scheduled Meet User and Doctor. 😄
                    </div>
                </div>
            </div>
<?php
   ...
   ?>
   <?php
   if($value['user_id']==Session('userid')&&$value['type']=='clinic'){ 
   ?>
...
?>
        ...
        <form class="msger-inputarea" method="POST" action="{{route('clinic_sendMessage')}}">
            @csrf
