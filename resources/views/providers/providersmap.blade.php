...
@section('title','Providers Visit | Dashboard');
@section('content');
{{-- {{dd($details)}} --}}
            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" action="{{route('providersMapSave')}}" method="POST"
                                ...
                                <tbody>
                                   @foreach ($details as $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('provider_visit_delete',$value['id'])}}">Delete</a>
                                            <a href="{{route('provider_slots_delete',$value['id'])}}">Navigate</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
