...
@section('title','Clinic Review | Dashboard');
@section('content');
{{-- {{dd($details)}} --}}
            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header">
                        <strong class="card-title">Review For Clinic</strong>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" action="{{route('clinicReviewSave')}}" method="POST"
