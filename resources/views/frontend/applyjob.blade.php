   ...
   <div class="container-fluid bg-primary py-5 hero-header mb-5">
    <div class="row py-3">
        <div class="col-12 text-center">
            <h1 class="display-3 text-white animated zoomIn">Apply Job</h1>
            <a href="" class="h4 text-white">Job</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="" class="h4 text-white">Apply Now</a>
        </div>
    </div>
</div>
<!-- Hero End -->
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class=" wow slideInUp" data-wow-delay="0.3s">
                <form method="POST" action="{{route('applyJobSave')}}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-12">
                            <input hidden required type="text" class="form-control border-0 bg-light px-4" placeholder="Your Name" value="{{$id}}" name="job_id"style="height: 55px;">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <input required name="mobile" type="text" class="form-control border-0 bg-light px-4" placeholder="Mobile Number" style="height: 55px;">
                        </div>
                        <div class="col-12">
